...
// RUN: %clang_cc1 -Wno-unused-value -O0 -internal-isystem %S/../../lib/Headers -include __clang_spirv_builtins.h -triple spirv64 -emit-llvm %s -x cl -cl-std=CL2.0 -o - | FileCheck %s -check-prefixes=CHECK64
...
// RUN: %clang_cc1 -Wno-unused-value -O0 -internal-isystem %S/../../lib/Headers -include __clang_spirv_builtins.h -triple spirv32 -emit-llvm %s -x cl -cl-std=CL2.0 -o - | FileCheck %s -check-prefixes=CHECK32
